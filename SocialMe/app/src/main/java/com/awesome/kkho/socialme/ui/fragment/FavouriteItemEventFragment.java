 ...
 */
public class FavouriteItemEventFragment extends Fragment implements Palette.PaletteAsyncListener {
    ...
    public void onStart() {
        super.onStart();
        Bitmap bitmap = FavouriteEventFragment.sPhotoCache.get(0);
